...
export const fatimaOmeletVideos = [
  { url: '/videos/module5/M5_Fatima_1.mp4', title: 'Vegetable Omelet - Part 1', subtitle: 'Watch Fatima make a vegetable omelet' },
  { url: '/videos/module5/M5_Fatima_2.mp4', title: 'Vegetable Omelet - Part 2', subtitle: 'Breaking the eggs' },
  { url: '/videos/module5/M5_Fatima_3.mp4', title: 'Vegetable Omelet - Part 3', subtitle: 'Adding the ingredients' },
  { url: '/videos/module5/M5_Fatima_4.mp4', title: 'Vegetable Omelet - Part 4', subtitle: 'Mixing it all together' },
  { url: '/videos/module5/M5_Fatima_5.mp4', title: 'Vegetable Omelet - Part 5', subtitle: 'Cooking the omelet' },
  { url: '/videos/module5/M5_Fatima_6.mp4', title: 'Vegetable Omelet - Part 6', subtitle: 'Flipping the omelet' },
  { url: '/videos/module5/M5_Fatima_7.mp4', title: 'Vegetable Omelet - Part 7', subtitle: 'Almost done!' },
  { url: '/videos/module5/M5_Fatima_8.mp4', title: 'Vegetable Omelet - Part 8', subtitle: 'Serving the omelet' },
];
