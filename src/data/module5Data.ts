...
export const containerVideos = [
  ...
  { url: '/videos/module5/M5_a_carton.mp4', title: 'A carton of juice', sentenceToRecord: 'A carton of juice.' },
  { url: '/videos/module5/M5_three_cartons.mp4', title: 'Three cartons of juice', sentenceToRecord: 'Three cartons of juice.' },
  { url: '/videos/module5/M5_a_gallon.mp4', title: 'A gallon of milk', sentenceToRecord: 'A gallon of milk.' },
  { url: '/videos/module5/M5_two_gallons.mp4', title: 'Two gallons of milk', sentenceToRecord: 'Two gallons of milk.' },
  { url: '/videos/module5/M5_a_package.mp4', title: 'A package of meat', sentenceToRecord: 'A package of meat.' },
  { url: '/videos/module5/M5_three_packages.mp4', title: 'Three packages of meat', sentenceToRecord: 'Three packages of meat.' },
  { url: '/videos/module5/M5_a_loaf.mp4', title: 'A loaf of bread', sentenceToRecord: 'A loaf of bread.' },
  { url: '/videos/module5/M5_four_loaves.mp4', title: 'Four loaves of bread', sentenceToRecord: 'Four loaves of bread.' },
  { url: '/videos/module5/M5_a_bag.mp4', title: 'A bag of flour', sentenceToRecord: 'A bag of flour.' },
  { url: '/videos/module5/M5_two_bags.mp4', title: 'Two bags of flour', sentenceToRecord: 'Two bags of flour.' },
  { url: '/videos/module5/M5_A_BAG_OF_FLOUR.mp4', title: 'A bag of flour', sentenceToRecord: 'A bag of flour.' },
  { url: '/videos/module5/M5_three_bags_of_flour.mp4', title: 'Three bags of flour', sentenceToRecord: 'Three bags of flour.' },
  { url: '/videos/module5/M5_A_PACKAGE_OF_CHEESE.mp4', title: 'A package of cheese', sentenceToRecord: 'A package of cheese.' },
  { url: '/videos/module5/M5_THREE_PACKAGES_OF_CHEESE.mp4', title: 'Three packages of cheese', sentenceToRecord: 'Three packages of cheese.' },
  { url: '/videos/module5/M5_A_bag_of_rice.mp4', title: 'A bag of rice', sentenceToRecord: 'A bag of rice.' },
  { url: '/videos/module5/M5_3_bags_of_rice.mp4', title: 'Three bags of rice', sentenceToRecord: 'Three bags of rice.' },
  { url: '/videos/module5/M5_a_box_of_tea.mp4', title: 'A box of tea', sentenceToRecord: 'A box of tea.' },
...
export interface Module5Lesson {
  ...
  title: string;
  description: string;
  type: 'vocabulary' | 'vocabulary-matching' | 'grocery-drag-drop' | 'video-series' | 'how-much-many' | 'sentence-order' | 'listening-fill-blank' | 'container-videos' | 'what-do-we-need' | 'grocery-list-quiz' | 'coins-and-bills' | 'how-much-price' | 'supermarket-flyer';
