...
export const uiTranslations: Partial<Record<SupportedLanguage, Record<string, string>>> = {
  arabic: {
    ...
    watchVideoTapItems: 'شاهد الفيديو، ثم انقر على العناصر الثلاثة التي تسمعها.',
    watchVideoAnswerQuestions: 'شاهد الفيديو، ثم أجب عن الأسئلة.',
    listenAndTapPrice: 'شاهد الفيديو وانقر على السعر الذي تسمعه.',
    listenRepeatCoins: 'استمع وكرر: العملات والأوراق النقدية',
    tapWhatYouHear: 'استمع إلى الصوت وانقر على العملة أو الورقة النقدية الصحيحة.',
    watchVideoRecordAnswer: 'شاهد الفيديو، واستمع إلى السؤال، ثم سجل إجابتك.',
    watchVideoChooseAnswer: 'شاهد الفيديو، ثم اختر الإجمالي الصحيح.',
    listenQuestionChooseAnswer: 'استمع إلى السؤال واختر الإجابة الصحيحة.',
    hearQuestion: 'اسمع السؤال',
    listenAgain: 'استمع مرة أخرى',
    checkAnswers: 'تحقق من الإجابات',
    selected: 'محدد',
    startQuiz: 'ابدأ الاختبار',
    whatIsTheTotal: 'ما هو المجموع؟',
    moduleComplete: 'اكتمل المقرر!',
    congratsModule: 'لقد أنهيت جميع الدروس في هذا المقرر!',
  ...
  bengali: {
    ...
    watchVideoTapItems: 'ভিডিওটি দেখুন, তারপর আপনি যে ৩টি জিনিস শুনতে পান তাতে ট্যাপ করুন।',
    watchVideoAnswerQuestions: 'ভিডিওটি দেখুন, তারপর প্রশ্নের উত্তর দিন।',
    listenAndTapPrice: 'ভিডিওটি দেখুন এবং আপনি যে দাম শুনতে পান তাতে ট্যাপ করুন।',
    listenRepeatCoins: 'শুনুন এবং পুনরাবৃত্তি করুন: মুদ্রা ও নোট',
    tapWhatYouHear: 'অডিও শুনুন এবং সঠিক মুদ্রা বা নোটে ট্যাপ করুন।',
    watchVideoRecordAnswer: 'ভিডিওটি দেখুন, প্রশ্ন শুনুন, তারপর আপনার উত্তর রেকর্ড করুন।',
    watchVideoChooseAnswer: 'ভিডিওটি দেখুন, তারপর সঠিক মোট নির্বাচন করুন।',
    listenQuestionChooseAnswer: 'প্রশ্ন শুনুন এবং সঠিক উত্তর নির্বাচন করুন।',
    hearQuestion: 'প্রশ্ন শুনুন',
    listenAgain: 'আবার শুনুন',
    checkAnswers: 'উত্তর পরীক্ষা করুন',
    selected: 'নির্বাচিত',
    startQuiz: 'কুইজ শুরু করুন',
    whatIsTheTotal: 'মোট কত?',
    moduleComplete: 'মডিউল সম্পন্ন!',
    congratsModule: 'আপনি এই মডিউলের সব পাঠ শেষ করেছেন!',
  ...
  korean: {
    ...
    watchVideoTapItems: '영상을 보고, 들리는 3가지 항목을 탭하세요.',
    watchVideoAnswerQuestions: '영상을 보고, 질문에 답하세요.',
    listenAndTapPrice: '영상을 보고 들리는 가격을 탭하세요.',
    listenRepeatCoins: '듣고 따라하세요: 동전과 지폐',
    tapWhatYouHear: '오디오를 듣고 올바른 동전이나 지폐를 탭하세요.',
    watchVideoRecordAnswer: '영상을 보고, 질문을 듣고, 답변을 녹음하세요.',
    watchVideoChooseAnswer: '영상을 보고, 올바른 총액을 선택하세요.',
    listenQuestionChooseAnswer: '질문을 듣고 올바른 답을 선택하세요.',
    hearQuestion: '질문 듣기',
    listenAgain: '다시 듣기',
    checkAnswers: '답 확인',
    selected: '선택됨',
    startQuiz: '퀴즈 시작',
    whatIsTheTotal: '총액은 얼마인가요?',
    moduleComplete: '모듈 완료!',
    congratsModule: '이 모듈의 모든 수업을 완료했습니다!',
  ...
  spanish: {
    ...
    watchVideoTapItems: 'Mira el video, luego toca los 3 artículos que escuches.',
    watchVideoAnswerQuestions: 'Mira el video, luego responde las preguntas.',
    listenAndTapPrice: 'Mira el video y toca el precio que escuches.',
    listenRepeatCoins: 'Escucha y repite: Monedas y billetes',
    tapWhatYouHear: 'Escucha el audio y toca la moneda o billete correcto.',
    watchVideoRecordAnswer: 'Mira el video, escucha la pregunta, luego graba tu respuesta.',
    watchVideoChooseAnswer: 'Mira el video, luego elige el total correcto.',
    listenQuestionChooseAnswer: 'Escucha la pregunta y elige la respuesta correcta.',
    hearQuestion: 'Escuchar la pregunta',
    listenAgain: 'Escuchar de nuevo',
    checkAnswers: 'Verificar respuestas',
    selected: 'seleccionados',
    startQuiz: 'Comenzar cuestionario',
    whatIsTheTotal: '¿Cuál es el total?',
    moduleComplete: '¡Módulo completado!',
    congratsModule: '¡Has terminado todas las lecciones de este módulo!',
  ...
  turkish: {
    ...
    watchVideoTapItems: 'Videoyu izle, sonra duyduğun 3 öğeye dokun.',
    watchVideoAnswerQuestions: 'Videoyu izle, sonra soruları cevapla.',
    listenAndTapPrice: 'Videoyu izle ve duyduğun fiyata dokun.',
    listenRepeatCoins: 'Dinle ve tekrarla: Madeni paralar ve banknotlar',
    tapWhatYouHear: 'Sesi dinle ve doğru madeni para veya banknota dokun.',
    watchVideoRecordAnswer: 'Videoyu izle, soruyu dinle, sonra cevabını kaydet.',
    watchVideoChooseAnswer: 'Videoyu izle, sonra doğru toplamı seç.',
    listenQuestionChooseAnswer: 'Soruyu dinle ve doğru cevabı seç.',
    hearQuestion: 'Soruyu dinle',
    listenAgain: 'Tekrar dinle',
    checkAnswers: 'Cevapları kontrol et',
    selected: 'seçildi',
    startQuiz: 'Teste başla',
    whatIsTheTotal: 'Toplam nedir?',
    moduleComplete: 'Modül tamamlandı!',
    congratsModule: 'Bu modüldeki tüm dersleri bitirdin!',
  ...
  chinese: {
    ...
    watchVideoTapItems: '观看视频，然后点击你听到的3个物品。',
    watchVideoAnswerQuestions: '观看视频，然后回答问题。',
    listenAndTapPrice: '观看视频并点击你听到的价格。',
    listenRepeatCoins: '听并重复：硬币和纸币',
    tapWhatYouHear: '听音频并点击正确的硬币或纸币。',
    watchVideoRecordAnswer: '观看视频，听问题，然后录下你的回答。',
    watchVideoChooseAnswer: '观看视频，然后选择正确的总额。',
    listenQuestionChooseAnswer: '听问题并选择正确的答案。',
    hearQuestion: '听问题',
    listenAgain: '再听一次',
    checkAnswers: '检查答案',
    selected: '已选择',
    startQuiz: '开始测验',
    whatIsTheTotal: '总共是多少？',
    moduleComplete: '模块完成！',
    congratsModule: '你已完成这个模块的所有课程！',
  ...
  hebrew: {
    ...
    watchVideoTapItems: '.צפו בסרטון, ואז הקישו על 3 הפריטים ששמעתם',
    watchVideoAnswerQuestions: '.צפו בסרטון, ואז ענו על השאלות',
    listenAndTapPrice: '.צפו בסרטון והקישו על המחיר ששמעתם',
    listenRepeatCoins: 'הקשיבו וחזרו: מטבעות ושטרות',
    tapWhatYouHear: '.הקשיבו לשמע והקישו על המטבע או השטר הנכון',
    watchVideoRecordAnswer: '.צפו בסרטון, הקשיבו לשאלה, ואז הקליטו את תשובתכם',
    watchVideoChooseAnswer: '.צפו בסרטון, ואז בחרו את הסכום הנכון',
    listenQuestionChooseAnswer: '.הקשיבו לשאלה ובחרו את התשובה הנכונה',
    hearQuestion: 'שמעו את השאלה',
    listenAgain: 'הקשיבו שוב',
    checkAnswers: 'בדקו תשובות',
    selected: 'נבחרו',
    startQuiz: 'התחל מבחן',
    whatIsTheTotal: '?מה הסכום הכולל',
    moduleComplete: '!המודול הושלם',
    congratsModule: '!סיימת את כל השיעורים במודול הזה',
...
export const vocabulary1: VocabularyItem[] = [
  { id: 'v1-apartment', english: 'apartment', pronunciation: 'uh-PART-ment', translations: { arabic: 'شقة', bengali: 'অ্যাপার্টমেন্ট', korean: '아파트', spanish: 'apartamento', chinese: '公寓', hebrew: 'דירה', turkish: 'daire' } },
  { id: 'v1-apartment-building', english: 'apartment building', pronunciation: 'uh-PART-ment BIL-ding', translations: { arabic: 'مبنى سكني', bengali: 'অ্যাপার্টমেন্ট বিল্ডিং', korean: '아파트 건물', spanish: 'edificio de apartamentos', chinese: '公寓楼', hebrew: 'בניין דירות', turkish: 'apartman' } },
  { id: 'v1-cashier', english: 'cashier', pronunciation: 'ka-SHEER', translations: { arabic: 'أمين الصندوق', bengali: 'ক্যাশিয়ার', korean: '계산원', spanish: 'cajero/a', chinese: '收银员', hebrew: 'קופאי/ת', turkish: 'kasiyer' } },
  { id: 'v1-divorced', english: 'divorced', pronunciation: 'di-VORSD', translations: { arabic: 'مطلق/مطلقة', bengali: 'তালাকপ্রাপ্ত', korean: '이혼한', spanish: 'divorciado/a', chinese: '离婚的', hebrew: 'גרוש/ה', turkish: 'boşanmış' } },
  { id: 'v1-from', english: 'from', pronunciation: 'from', translations: { arabic: 'من', bengali: 'থেকে', korean: '~에서', spanish: 'de', chinese: '从', hebrew: 'מ-', turkish: '-den/-dan' } },
  { id: 'v1-have', english: 'have', pronunciation: 'hav', translations: { arabic: 'لديه/لديها', bengali: 'আছে', korean: '가지다', spanish: 'tener', chinese: '有', hebrew: 'יש ל-', turkish: 'sahip olmak' } },
  { id: 'v1-in', english: 'in', pronunciation: 'in', translations: { arabic: 'في', bengali: 'মধ্যে', korean: '~안에', spanish: 'en', chinese: '在...里', hebrew: 'ב-', turkish: '-de/-da' } },
  
  { id: 'v1-married', english: 'married', pronunciation: 'MAR-eed', translations: { arabic: 'متزوج/متزوجة', bengali: 'বিবাহিত', korean: '결혼한', spanish: 'casado/a', chinese: '已婚的', hebrew: 'נשוי/אה', turkish: 'evli' } },
  { id: 'v1-single', english: 'single', pronunciation: 'SING-gul', translations: { arabic: 'أعزب/عزباء', bengali: 'অবিবাহিত', korean: '미혼', spanish: 'soltero/a', chinese: '单身的', hebrew: 'רווק/ה', turkish: 'bekar' } },
  { id: 'v1-supermarket', english: 'supermarket', pronunciation: 'SOO-per-mar-kit', translations: { arabic: 'سوبرماركت', bengali: 'সুপারমার্কেট', korean: '슈퍼마켓', spanish: 'supermercado', chinese: '超市', hebrew: 'סופרמרקט', turkish: 'süpermarket' } },
  { id: 'v1-work', english: 'work', pronunciation: 'werk', translations: { arabic: 'يعمل', bengali: 'কাজ করা', korean: '일하다', spanish: 'trabajar', chinese: '工作', hebrew: 'לעבוד', turkish: 'çalışmak' } },
];

// Vocabulary Set 2 - Neighborhood and Questions
export const vocabulary2: VocabularyItem[] = [
  { id: 'v2-children', english: 'children', pronunciation: 'CHIL-dren', translations: { arabic: 'أطفال', bengali: 'বাচ্চারা', korean: '아이들', spanish: 'niños', chinese: '孩子们', hebrew: 'ילדים', turkish: 'çocuklar' } },
  { id: 'v2-hotel', english: 'hotel', pronunciation: 'hoh-TEL', translations: { arabic: 'فندق', bengali: 'হোটেল', korean: '호텔', spanish: 'hotel', chinese: '酒店', hebrew: 'מלון', turkish: 'otel' } },
  { id: 'v2-housekeeper', english: 'housekeeper', pronunciation: 'HOUS-kee-per', translations: { arabic: 'عامل/ة نظافة', bengali: 'গৃহপরিচারিকা', korean: '가정부', spanish: 'ama de llaves', chinese: '管家', hebrew: 'עוזר/ת בית', turkish: 'temizlikçi' } },
  { id: 'v2-job', english: 'job', pronunciation: 'job', translations: { arabic: 'وظيفة', bengali: 'চাকরি', korean: '직업', spanish: 'trabajo', chinese: '工作', hebrew: 'עבודה', turkish: 'iş' } },
  { id: 'v2-neighbor', english: 'neighbor', pronunciation: 'NAY-ber', translations: { arabic: 'جار', bengali: 'প্রতিবেশী', korean: '이웃', spanish: 'vecino/a', chinese: '邻居', hebrew: 'שכן/ה', turkish: 'komşu' } },
  { id: 'v2-neighborhood', english: 'neighborhood', pronunciation: 'NAY-ber-hood', translations: { arabic: 'حي', bengali: 'পাড়া', korean: '동네', spanish: 'vecindario', chinese: '社区', hebrew: 'שכונה', turkish: 'mahalle' } },
  { id: 'v2-new', english: 'new', pronunciation: 'noo', translations: { arabic: 'جديد', bengali: 'নতুন', korean: '새로운', spanish: 'nuevo/a', chinese: '新的', hebrew: 'חדש/ה', turkish: 'yeni' } },
  { id: 'v2-what', english: 'what', pronunciation: 'wut', translations: { arabic: 'ماذا', bengali: 'কি', korean: '무엇', spanish: 'qué', chinese: '什么', hebrew: 'מה', turkish: 'ne' } },
  { id: 'v2-where', english: 'where', pronunciation: 'wer', translations: { arabic: 'أين', bengali: 'কোথায়', korean: '어디', spanish: 'dónde', chinese: '哪里', hebrew: 'איפה', turkish: 'nerede' } },
  { id: 'v2-with', english: 'with', pronunciation: 'with', translations: { arabic: 'مع', bengali: 'সাথে', korean: '~와 함께', spanish: 'con', chinese: '和...一起', hebrew: 'עם', turkish: 'ile' } },
];

// Questions Vocabulary - What to ask people
export const questionsVocabulary: VocabularyItem[] = [
  { id: 'q-what-is-your-name', english: 'What is your name?', pronunciation: 'wut iz yor naym', translations: { arabic: 'ما اسمك؟', bengali: 'তোমার নাম কি?', korean: '이름이 뭐예요?', spanish: '¿Cuál es tu nombre?', chinese: '你叫什么名字？', hebrew: '?מה שמך', turkish: 'Adın ne?' } },
  { id: 'q-where-are-you-from', english: 'Where are you from?', pronunciation: 'wer ar yoo from', translations: { arabic: 'من أين أنت؟', bengali: 'তুমি কোথা থেকে?', korean: '어디에서 왔어요?', spanish: '¿De dónde eres?', chinese: '你来自哪里？', hebrew: '?מאיפה את/ה', turkish: 'Nerelisin?' } },
  { id: 'q-how-old-are-you', english: 'How old are you?', pronunciation: 'how ohld ar yoo', translations: { arabic: 'كم عمرك؟', bengali: 'তোমার বয়স কত?', korean: '몇 살이에요?', spanish: '¿Cuántos años tienes?', chinese: '你几岁了？', hebrew: '?בן/בת כמה את/ה', turkish: 'Kaç yaşındasın?' } },
  { id: 'q-are-you-married', english: 'Are you married or single?', pronunciation: 'ar yoo MAR-eed or SING-gul', translations: { arabic: 'هل أنت متزوج أم أعزب؟', bengali: 'তুমি কি বিবাহিত না অবিবাহিত?', korean: '결혼했어요, 아니면 미혼이에요?', spanish: '¿Estás casado/a o soltero/a?', chinese: '你结婚了还是单身？', hebrew: '?את/ה נשוי/אה או רווק/ה', turkish: 'Evli misin bekar mı?' } },
  { id: 'q-do-you-have-children', english: 'Do you have children?', pronunciation: 'doo yoo hav CHIL-dren', translations: { arabic: 'هل لديك أطفال؟', bengali: 'তোমার কি বাচ্চা আছে?', korean: '아이가 있으세요?', spanish: '¿Tienes hijos?', chinese: '你有孩子吗？', hebrew: '?יש לך ילדים', turkish: 'Çocuğun var mı?' } },
  { id: 'q-do-you-work', english: 'Do you work?', pronunciation: 'doo yoo werk', translations: { arabic: 'هل تعمل؟', bengali: 'তুমি কি কাজ কর?', korean: '일을 하세요?', spanish: '¿Trabajas?', chinese: '你工作吗？', hebrew: '?את/ה עובד/ת', turkish: 'Çalışıyor musun?' } },
  { id: 'q-what-do-you-do', english: 'What do you do?', pronunciation: 'wut doo yoo doo', translations: { arabic: 'ماذا تعمل؟', bengali: 'তুমি কি কর?', korean: '무슨 일을 해요?', spanish: '¿A qué te dedicas?', chinese: '你做什么工作？', hebrew: '?מה את/ה עושה', turkish: 'Ne iş yapıyorsun?' } },
  { id: 'q-where-do-you-work', english: 'Where do you work?', pronunciation: 'wer doo yoo werk', translations: { arabic: 'أين تعمل؟', bengali: 'তুমি কোথায় কাজ কর?', korean: '어디서 일해요?', spanish: '¿Dónde trabajas?', chinese: '你在哪里工作？', hebrew: '?איפה את/ה עובד/ת', turkish: 'Nerede çalışıyorsun?' } },
];
...
export const numbers0to10: VocabularyItem[] = [
  { id: 'num-0', english: 'zero', pronunciation: 'ZEE-roh', translations: { arabic: 'صفر', bengali: 'শূন্য', korean: '영', spanish: 'cero', chinese: '零', hebrew: 'אפס', turkish: 'sıfır' } },
  { id: 'num-1', english: 'one', pronunciation: 'wun', translations: { arabic: 'واحد', bengali: 'এক', korean: '일', spanish: 'uno', chinese: '一', hebrew: 'אחד', turkish: 'bir' } },
  { id: 'num-2', english: 'two', pronunciation: 'too', translations: { arabic: 'اثنان', bengali: 'দুই', korean: '이', spanish: 'dos', chinese: '二', hebrew: 'שניים', turkish: 'iki' } },
  { id: 'num-3', english: 'three', pronunciation: 'three', translations: { arabic: 'ثلاثة', bengali: 'তিন', korean: '삼', spanish: 'tres', chinese: '三', hebrew: 'שלושה', turkish: 'üç' } },
  { id: 'num-4', english: 'four', pronunciation: 'for', translations: { arabic: 'أربعة', bengali: 'চার', korean: '사', spanish: 'cuatro', chinese: '四', hebrew: 'ארבעה', turkish: 'dört' } },
  { id: 'num-5', english: 'five', pronunciation: 'fahyv', translations: { arabic: 'خمسة', bengali: 'পাঁচ', korean: '오', spanish: 'cinco', chinese: '五', hebrew: 'חמישה', turkish: 'beş' } },
  { id: 'num-6', english: 'six', pronunciation: 'siks', translations: { arabic: 'ستة', bengali: 'ছয়', korean: '육', spanish: 'seis', chinese: '六', hebrew: 'שישה', turkish: 'altı' } },
  { id: 'num-7', english: 'seven', pronunciation: 'SEV-en', translations: { arabic: 'سبعة', bengali: 'সাত', korean: '칠', spanish: 'siete', chinese: '七', hebrew: 'שבעה', turkish: 'yedi' } },
  { id: 'num-8', english: 'eight', pronunciation: 'ayt', translations: { arabic: 'ثمانية', bengali: 'আট', korean: '팔', spanish: 'ocho', chinese: '八', hebrew: 'שמונה', turkish: 'sekiz' } },
  { id: 'num-9', english: 'nine', pronunciation: 'nahyn', translations: { arabic: 'تسعة', bengali: 'নয়', korean: '구', spanish: 'nueve', chinese: '九', hebrew: 'תשעה', turkish: 'dokuz' } },
  { id: 'num-10', english: 'ten', pronunciation: 'ten', translations: { arabic: 'عشرة', bengali: 'দশ', korean: '십', spanish: 'diez', chinese: '十', hebrew: 'עשרה', turkish: 'on' } },
];

// Numbers 11-20
export const numbers11to20: VocabularyItem[] = [
  { id: 'num-11', english: 'eleven', pronunciation: 'i-LEV-en', translations: { arabic: 'أحد عشر', bengali: 'এগারো', korean: '십일', spanish: 'once', chinese: '十一', hebrew: 'אחד עשר', turkish: 'on bir' } },
  { id: 'num-12', english: 'twelve', pronunciation: 'twelv', translations: { arabic: 'اثنا عشر', bengali: 'বারো', korean: '십이', spanish: 'doce', chinese: '十二', hebrew: 'שנים עשר', turkish: 'on iki' } },
  { id: 'num-13', english: 'thirteen', pronunciation: 'ther-TEEN', translations: { arabic: 'ثلاثة عشر', bengali: 'তেরো', korean: '십삼', spanish: 'trece', chinese: '十三', hebrew: 'שלושה עשר', turkish: 'on üç' } },
  { id: 'num-14', english: 'fourteen', pronunciation: 'for-TEEN', translations: { arabic: 'أربعة عشر', bengali: 'চৌদ্দ', korean: '십사', spanish: 'catorce', chinese: '十四', hebrew: 'ארבעה עשר', turkish: 'on dört' } },
  { id: 'num-15', english: 'fifteen', pronunciation: 'fif-TEEN', translations: { arabic: 'خمسة عشر', bengali: 'পনেরো', korean: '십오', spanish: 'quince', chinese: '十五', hebrew: 'חמישה עשר', turkish: 'on beş' } },
  { id: 'num-16', english: 'sixteen', pronunciation: 'siks-TEEN', translations: { arabic: 'ستة عشر', bengali: 'ষোল', korean: '십육', spanish: 'dieciséis', chinese: '十六', hebrew: 'שישה עשר', turkish: 'on altı' } },
  { id: 'num-17', english: 'seventeen', pronunciation: 'sev-en-TEEN', translations: { arabic: 'سبعة عشر', bengali: 'সতেরো', korean: '십칠', spanish: 'diecisiete', chinese: '十七', hebrew: 'שבעה עשר', turkish: 'on yedi' } },
  { id: 'num-18', english: 'eighteen', pronunciation: 'ay-TEEN', translations: { arabic: 'ثمانية عشر', bengali: 'আঠারো', korean: '십팔', spanish: 'dieciocho', chinese: '十八', hebrew: 'שמונה עשר', turkish: 'on sekiz' } },
  { id: 'num-19', english: 'nineteen', pronunciation: 'nahyn-TEEN', translations: { arabic: 'تسعة عشر', bengali: 'উনিশ', korean: '십구', spanish: 'diecinueve', chinese: '十九', hebrew: 'תשעה עשר', turkish: 'on dokuz' } },
  { id: 'num-20', english: 'twenty', pronunciation: 'TWEN-tee', translations: { arabic: 'عشرون', bengali: 'বিশ', korean: '이십', spanish: 'veinte', chinese: '二十', hebrew: 'עשרים', turkish: 'yirmi' } },
];

// Numbers 21-40
export const numbers21to40: VocabularyItem[] = [
  { id: 'num-21', english: 'twenty-one', pronunciation: '', translations: { arabic: 'واحد وعشرون', bengali: 'একুশ', korean: '이십일', spanish: 'veintiuno', chinese: '二十一', hebrew: 'עשרים ואחד', turkish: 'yirmi bir' } },
  { id: 'num-22', english: 'twenty-two', pronunciation: '', translations: { arabic: 'اثنان وعشرون', bengali: 'বাইশ', korean: '이십이', spanish: 'veintidós', chinese: '二十二', hebrew: 'עשרים ושניים', turkish: 'yirmi iki' } },
  { id: 'num-23', english: 'twenty-three', pronunciation: '', translations: { arabic: 'ثلاثة وعشرون', bengali: 'তেইশ', korean: '이십삼', spanish: 'veintitrés', chinese: '二十三', hebrew: 'עשרים ושלושה', turkish: 'yirmi üç' } },
  { id: 'num-24', english: 'twenty-four', pronunciation: '', translations: { arabic: 'أربعة وعشرون', bengali: 'চব্বিশ', korean: '이십사', spanish: 'veinticuatro', chinese: '二十四', hebrew: 'עשרים וארבעה', turkish: 'yirmi dört' } },
  { id: 'num-25', english: 'twenty-five', pronunciation: '', translations: { arabic: 'خمسة وعشرون', bengali: 'পঁচিশ', korean: '이십오', spanish: 'veinticinco', chinese: '二十五', hebrew: 'עשרים וחמישה', turkish: 'yirmi beş' } },
  { id: 'num-26', english: 'twenty-six', pronunciation: '', translations: { arabic: 'ستة وعشرون', bengali: 'ছাব্বিশ', korean: '이십육', spanish: 'veintiséis', chinese: '二十六', hebrew: 'עשרים ושישה', turkish: 'yirmi altı' } },
  { id: 'num-27', english: 'twenty-seven', pronunciation: '', translations: { arabic: 'سبعة وعشرون', bengali: 'সাতাশ', korean: '이십칠', spanish: 'veintisiete', chinese: '二十七', hebrew: 'עשרים ושבעה', turkish: 'yirmi yedi' } },
  { id: 'num-28', english: 'twenty-eight', pronunciation: '', translations: { arabic: 'ثمانية وعشرون', bengali: 'আটাশ', korean: '이십팔', spanish: 'veintiocho', chinese: '二十八', hebrew: 'עשרים ושמונה', turkish: 'yirmi sekiz' } },
  { id: 'num-29', english: 'twenty-nine', pronunciation: '', translations: { arabic: 'تسعة وعشرون', bengali: 'ঊনত্রিশ', korean: '이십구', spanish: 'veintinueve', chinese: '二十九', hebrew: 'עשרים ותשעה', turkish: 'yirmi dokuz' } },
  { id: 'num-30', english: 'thirty', pronunciation: '', translations: { arabic: 'ثلاثون', bengali: 'ত্রিশ', korean: '삼십', spanish: 'treinta', chinese: '三十', hebrew: 'שלושים', turkish: 'otuz' } },
  { id: 'num-31', english: 'thirty-one', pronunciation: '', translations: { arabic: 'واحد وثلاثون', bengali: 'একত্রিশ', korean: '삼십일', spanish: 'treinta y uno', chinese: '三十一', hebrew: 'שלושים ואחד', turkish: 'otuz bir' } },
  { id: 'num-32', english: 'thirty-two', pronunciation: '', translations: { arabic: 'اثنان وثلاثون', bengali: 'বত্রিশ', korean: '삼십이', spanish: 'treinta y dos', chinese: '三十二', hebrew: 'שלושים ושניים', turkish: 'otuz iki' } },
  { id: 'num-33', english: 'thirty-three', pronunciation: '', translations: { arabic: 'ثلاثة وثلاثون', bengali: 'তেত্রিশ', korean: '삼십삼', spanish: 'treinta y tres', chinese: '三十三', hebrew: 'שלושים ושלושה', turkish: 'otuz üç' } },
  { id: 'num-34', english: 'thirty-four', pronunciation: '', translations: { arabic: 'أربعة وثلاثون', bengali: 'চৌত্রিশ', korean: '삼십사', spanish: 'treinta y cuatro', chinese: '三十四', hebrew: 'שלושים וארבעה', turkish: 'otuz dört' } },
  { id: 'num-35', english: 'thirty-five', pronunciation: '', translations: { arabic: 'خمسة وثلاثون', bengali: 'পঁয়ত্রিশ', korean: '삼십오', spanish: 'treinta y cinco', chinese: '三十五', hebrew: 'שלושים וחמישה', turkish: 'otuz beş' } },
  { id: 'num-36', english: 'thirty-six', pronunciation: '', translations: { arabic: 'ستة وثلاثون', bengali: 'ছত্রিশ', korean: '삼십육', spanish: 'treinta y seis', chinese: '三十六', hebrew: 'שלושים ושישה', turkish: 'otuz altı' } },
  { id: 'num-37', english: 'thirty-seven', pronunciation: '', translations: { arabic: 'سبعة وثلاثون', bengali: 'সাঁইত্রিশ', korean: '삼십칠', spanish: 'treinta y siete', chinese: '三十七', hebrew: 'שלושים ושבעה', turkish: 'otuz yedi' } },
  { id: 'num-38', english: 'thirty-eight', pronunciation: '', translations: { arabic: 'ثمانية وثلاثون', bengali: 'আটত্রিশ', korean: '삼십팔', spanish: 'treinta y ocho', chinese: '三十八', hebrew: 'שלושים ושמונה', turkish: 'otuz sekiz' } },
  { id: 'num-39', english: 'thirty-nine', pronunciation: '', translations: { arabic: 'تسعة وثلاثون', bengali: 'ঊনচল্লিশ', korean: '삼십구', spanish: 'treinta y nueve', chinese: '三十九', hebrew: 'שלושים ותשעה', turkish: 'otuz dokuz' } },
  { id: 'num-40', english: 'forty', pronunciation: '', translations: { arabic: 'أربعون', bengali: 'চল্লিশ', korean: '사십', spanish: 'cuarenta', chinese: '四十', hebrew: 'ארבעים', turkish: 'kırk' } },
];

// Numbers 41-60
export const numbers41to60: VocabularyItem[] = [
  { id: 'num-41', english: 'forty-one', pronunciation: '', translations: { arabic: 'واحد وأربعون', bengali: 'একচল্লিশ', korean: '사십일', spanish: 'cuarenta y uno', chinese: '四十一', hebrew: 'ארבעים ואחד', turkish: 'kırk bir' } },
  { id: 'num-42', english: 'forty-two', pronunciation: '', translations: { arabic: 'اثنان وأربعون', bengali: 'বিয়াল্লিশ', korean: '사십이', spanish: 'cuarenta y dos', chinese: '四十二', hebrew: 'ארבעים ושניים', turkish: 'kırk iki' } },
  { id: 'num-43', english: 'forty-three', pronunciation: '', translations: { arabic: 'ثلاثة وأربعون', bengali: 'তেতাল্লিশ', korean: '사십삼', spanish: 'cuarenta y tres', chinese: '四十三', hebrew: 'ארבעים ושלושה', turkish: 'kırk üç' } },
  { id: 'num-44', english: 'forty-four', pronunciation: '', translations: { arabic: 'أربعة وأربعون', bengali: 'চুয়াল্লিশ', korean: '사십사', spanish: 'cuarenta y cuatro', chinese: '四十四', hebrew: 'ארבעים וארבעה', turkish: 'kırk dört' } },
  { id: 'num-45', english: 'forty-five', pronunciation: '', translations: { arabic: 'خمسة وأربعون', bengali: 'পঁয়তাল্লিশ', korean: '사십오', spanish: 'cuarenta y cinco', chinese: '四十五', hebrew: 'ארבעים וחמישה', turkish: 'kırk beş' } },
  { id: 'num-46', english: 'forty-six', pronunciation: '', translations: { arabic: 'ستة وأربعون', bengali: 'ছেচল্লিশ', korean: '사십육', spanish: 'cuarenta y seis', chinese: '四十六', hebrew: 'ארבעים ושישה', turkish: 'kırk altı' } },
  { id: 'num-47', english: 'forty-seven', pronunciation: '', translations: { arabic: 'سبعة وأربعون', bengali: 'সাতচল্লিশ', korean: '사십칠', spanish: 'cuarenta y siete', chinese: '四十七', hebrew: 'ארבעים ושבעה', turkish: 'kırk yedi' } },
  { id: 'num-48', english: 'forty-eight', pronunciation: '', translations: { arabic: 'ثمانية وأربعون', bengali: 'আটচল্লিশ', korean: '사십팔', spanish: 'cuarenta y ocho', chinese: '四十八', hebrew: 'ארבעים ושמונה', turkish: 'kırk sekiz' } },
  { id: 'num-49', english: 'forty-nine', pronunciation: '', translations: { arabic: 'تسعة وأربعون', bengali: 'ঊনপঞ্চাশ', korean: '사십구', spanish: 'cuarenta y nueve', chinese: '四十九', hebrew: 'ארבעים ותשעה', turkish: 'kırk dokuz' } },
  { id: 'num-50', english: 'fifty', pronunciation: '', translations: { arabic: 'خمسون', bengali: 'পঞ্চাশ', korean: '오십', spanish: 'cincuenta', chinese: '五十', hebrew: 'חמישים', turkish: 'elli' } },
  { id: 'num-51', english: 'fifty-one', pronunciation: '', translations: { arabic: 'واحد وخمسون', bengali: 'একান্ন', korean: '오십일', spanish: 'cincuenta y uno', chinese: '五十一', hebrew: 'חמישים ואחד', turkish: 'elli bir' } },
  { id: 'num-52', english: 'fifty-two', pronunciation: '', translations: { arabic: 'اثنان وخمسون', bengali: 'বাহান্ন', korean: '오십이', spanish: 'cincuenta y dos', chinese: '五十二', hebrew: 'חמישים ושניים', turkish: 'elli iki' } },
  { id: 'num-53', english: 'fifty-three', pronunciation: '', translations: { arabic: 'ثلاثة وخمسون', bengali: 'তিপ্পান্ন', korean: '오십삼', spanish: 'cincuenta y tres', chinese: '五十三', hebrew: 'חמישים ושלושה', turkish: 'elli üç' } },
  { id: 'num-54', english: 'fifty-four', pronunciation: '', translations: { arabic: 'أربعة وخمسون', bengali: 'চুয়ান্ন', korean: '오십사', spanish: 'cincuenta y cuatro', chinese: '五十四', hebrew: 'חמישים וארבעה', turkish: 'elli dört' } },
  { id: 'num-55', english: 'fifty-five', pronunciation: '', translations: { arabic: 'خمسة وخمسون', bengali: 'পঞ্চান্ন', korean: '오십오', spanish: 'cincuenta y cinco', chinese: '五十五', hebrew: 'חמישים וחמישה', turkish: 'elli beş' } },
  { id: 'num-56', english: 'fifty-six', pronunciation: '', translations: { arabic: 'ستة وخمسون', bengali: 'ছাপ্পান্ন', korean: '오십육', spanish: 'cincuenta y seis', chinese: '五十六', hebrew: 'חמישים ושישה', turkish: 'elli altı' } },
  { id: 'num-57', english: 'fifty-seven', pronunciation: '', translations: { arabic: 'سبعة وخمسون', bengali: 'সাতান্ন', korean: '오십칠', spanish: 'cincuenta y siete', chinese: '五十七', hebrew: 'חמישים ושבעה', turkish: 'elli yedi' } },
  { id: 'num-58', english: 'fifty-eight', pronunciation: '', translations: { arabic: 'ثمانية وخمسون', bengali: 'আটান্ন', korean: '오십팔', spanish: 'cincuenta y ocho', chinese: '五十八', hebrew: 'חמישים ושמונה', turkish: 'elli sekiz' } },
  { id: 'num-59', english: 'fifty-nine', pronunciation: '', translations: { arabic: 'تسعة وخمسون', bengali: 'ঊনষাট', korean: '오십구', spanish: 'cincuenta y nueve', chinese: '五十九', hebrew: 'חמישים ותשעה', turkish: 'elli dokuz' } },
  { id: 'num-60', english: 'sixty', pronunciation: '', translations: { arabic: 'ستون', bengali: 'ষাট', korean: '육십', spanish: 'sesenta', chinese: '六十', hebrew: 'שישים', turkish: 'altmış' } },
];
...
export const marisolVideos = [
  ...
  { url: '/videos/module1/m1-marisol-peru.mp4', title: 'I am from Peru.', subtitle: 'Telling where you are from', translations: { arabic: 'أنا من بيرو.', bengali: 'আমি পেরু থেকে।', korean: '저는 페루 출신이에요.', spanish: 'Soy de Perú.', turkish: 'Peru\'luyum.' } },
